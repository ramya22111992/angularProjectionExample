...
export class ContentProjectionComponent implements OnInit {
  ...
  @ContentChildren('contChildren')contChildren:QueryList<ElementRef>;
  @ContentChild('contChild')contChild:ElementRef;

  ngAfterContentInit(){
    console.log("Content Children",this.contChildren.toArray());
    console.log("Content Child",this.contChild);
  }
